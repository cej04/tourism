         ...
         GestureDetector(
             onTap: () {
                  ...
                  Navigator.push(context, MaterialPageRoute(
                   builder: (context) {
                     return StateOwnedDetailsPage(stateowned: stateOwned,);
                   } ),
                  );
                },
           child: Container(
            ...
            image: AssetImage(stateOwned.image))
              ...
              child: Padding(
               ...
               child: Text(stateOwned.title.toUpperCase(),  style: Theme.of(context).textTheme.caption?.apply(color: Colors.white,backgroundColor:Colors.black.withOpacity(0.5), ).copyWith(letterSpacing: 1))
              )
