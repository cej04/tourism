           ...
           Expanded(
            ...
            image: AssetImage(stateowned.image))
              ...
              child: Padding(
               ...
               child: Text(stateowned.title.toUpperCase(),  style: Theme.of(context).textTheme.labelMedium?.apply(color: Colors.white,backgroundColor:Colors.black.withOpacity(0.5), ).copyWith(letterSpacing: 1))
              )
