class KumaraKom {
  final String name, subname, image, desc, contact, ph, reach, stay, email, activity;

  double latitude, longitude, more;
...
List<KumaraKom> Kumarakom = [
  KumaraKom(
      ...
      stay:
          "https://www.keralatourism.org/where-to-stay/kumarakom-kottayam/112",
      latitude: 9.617119,
      longitude: 76.429482,
      more: 1),
  KumaraKom(
    name: "Canal Cruise",
    subname: "Enjoy backwater stretches and pristine paddy fields",
  ...
  KumaraKom(
    ...
    stay: "",
    activity:
        "• Coconut Tree Climbing • Toddy Tapping • Weaving Coconut Leaves  • Net Fishing • Coir Making• Bow and Arrow Fishing  • Screw pines Weaving • Farm Visit• Paddy field visit • Canal Cruising",
