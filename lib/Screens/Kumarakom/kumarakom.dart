class KumaraKom {
  final String name, image, desc, contact, ph, reach, stay,email,activity;
...
List<KumaraKom> Kumarakom = [
  ...
  KumaraKom(
    ...
    reach: "",
    stay: "",
    activity:"• Coconut Tree Climbing • Toddy Tapping • Weaving Coconut Leaves  • Net Fishing • Coir Making• Bow and Arrow Fishing  • Screw pines Weaving • Farm Visit• Paddy field visit • Canal Cruising",
