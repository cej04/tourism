class Pilgrims {
  final String image, title, subtitle, distance, description;
...
List<Pilgrims> pilgrims = [
  ...
  Pilgrims(
      ...
      distance: "9 km",
      description:
          "Located 9 km away from Kottayam town, the St. Mary’s Church at Manarcaud is one of the most important churches of the Malankara Jacobite Syrian Christians. The ettunompu (8-day fasting) which is an annual event held between September 1st and 8th of every year sees devotees from far and wide thronging the church to participate in the prayers and rituals.\n\nThe church architecture resembles that of the Orvieto Cathedral. The church administers various spiritual organisations, schools and a hospital.",
      lat: 9.59988435491,
      long: 76.5853019716),
  Pilgrims(
  ...
  Pilgrims(
      ...
      distance: "50 km",
      description:
          "Located at about 50 km from Kottayam is the Vavarambalam at Erumeli which is a mosque dedicated to Vavar, a companion of the deity Lord Ayyappa of the Sabarimala Temple. The mosque enjoys a unique status in that the Hindu pilgrims pay their respects to Vavar at the Vavarambalam before embarking on their trek to Sabarimala. The festival here is the Erumeli Pettathullal held in the month of January.\n\nThe mosque has an imposing structure which large domes and a number of minarets. The mosque is visited by a lot of tourists for its architectural magnificence and simplicity. The mosque has a Muslim saint for performing the daily rites, since Vavar followed the religion of Islam. The mosque doesn’t have a statue, but has a stone slab with inscriptions on it, just like how other masjids have. The walls are covered with green silk cloth and there is also a sword which belonged to Vavar, symbolising his valour.",
      lat: 9.45709237535,
      long: 76.857055361),
  Pilgrims(
