...
List<PilgrimViewMore> pilgrimviewmore = [
  PilgrimViewMore(
    ...
    desc:
        "(11 km from Kottayam)\n\nBelieved to be one of the seven churches established by St. Thomas, this is also one of the churches in Kerala which collects the largest amount of monetary offerings during the festival days.\n\n The annual feast is celebrated from 22nd to 24th of April.",
  ...
  PilgrimViewMore(
    ...
    desc:
        "(3 km from Kottayam)\n\nThis is one of the eight temples established by Sage Parasurama,the mythical creator of Kerala.\n\nAnnual festival: Sankranti Vanibhyam - a fair of household articles(June/July)",
    bgcolor: Color(0xFFFFF7EC),
    iconColor: Color.fromARGB(255, 236, 199, 119),
  ),
  PilgrimViewMore(
  ...
  PilgrimViewMore(
      ...
      desc:
          "(18 km from Kottayam)\n\nThis temple is famous for its Mudiyeduppu Utsavam (festival) celebrated once in 12 years and the rare art forms connected with It. \nThe procession carrying madhu (honey) and kulavazha (plantain tree with the fruit), and rituals like bhairavi purapadu, darika vadha purappadu, etc. are grand affairs.",
      bgcolor: Color(0XFFEDF4FE),
      iconColor: Color.fromARGB(255, 96, 151, 219)),
  PilgrimViewMore(
    ...
    desc:
        "(18 km from Kottayam)\n\nLocated at Puzhavathu, Kavil Bhagavathy Temple was built by one of the Thekkumkoor Maharajas where the ancestral deity of the Thekkumkoor Royal Family was worshipped.\n This temple is well known for the festive ceremony of Chandana Kudam one of the most Important ancestral ceremonies here. It has been conducted for many generations now, during the Kavil chirappu (Dec-Jan).",
    bgcolor: Color(0xFFFFF7EC),
    iconColor: Color.fromARGB(255, 236, 199, 119),
  ),
  PilgrimViewMore(
  ...
  PilgrimViewMore(
      ...
      desc:
          "(2 km from Kottayam)\n\nThe temple of Pallipurathu Kavu is dedicated to Goddess Durga, who is referred to as 'Pallippurathamma' by worshipers and is known for the festival Pathamudaya Mahotsavam. It is famous for the Nadel Thiyattu performance. \nOne of the most attractive features of Pallipurathu Kavu is the unique art form of Theeyattu which is practiced as a ritual offering.",
      bgcolor: Color(0XFFEDF4FE),
      iconColor: Color.fromARGB(255, 96, 151, 219)),
  PilgrimViewMore(
  ...
  PilgrimViewMore(
      ...
      desc:
          "(40 km from Kottayam)\n\nPuthenpalli Juma Masjid is a famous mosque located at Erattupetta.\n\nThe famous Chandanakudam is celebrated here in February/December.",
      bgcolor: Color(0xFFFCF0F0),
      iconColor: Color.fromARGB(255, 236, 151, 158)),
  PilgrimViewMore(
      ...
      desc:
          "(2 km from Kottayam)\n\nThis is the place of worship of the erstwhile Thekkumkoor Royal Family, \n\nAnnual festival: Ten-day utsavam (April-May), \nShivarathri (January-February)",
      bgcolor: Color(0XFFEDF4FE),
      iconColor: Color.fromARGB(255, 96, 151, 219)),
  PilgrimViewMore(
    ...
    desc:
        "(40 km from Kottayam)\n\nAssociated with Lord Parasurama, this temple is a typical example of the Kerala style of temple architecture. Renowned as the Kasi of the South, this temple is famous for its elephant pageants and traditional art performances. \n\nAnnual festival Vakathashtami (November/December)",
    bgcolor: Color(0xFFFFF7EC),
    iconColor: Color.fromARGB(255, 236, 199, 119),
  ),
  PilgrimViewMore(
      ...
      desc:
          "(20 km from Kottayam) \n\nThis temple is dedicated to Lord Subramanya who is projected in Ugra Bhava (aggressive disposition). The idol of Lord Muruga in this temple is unique as this is the only Subramanya idol wherein the deity is holding the Vel (spear) pointed downwards. \n\nThe temple hosts the world famous Thaipooya Kavadiyattam (Kavadi) festival celebrated annually in January February.",
      bgcolor: Color(0xFFFCF0F0),
      iconColor: Color.fromARGB(255, 236, 151, 158)),
  PilgrimViewMore(
  ...
  PilgrimViewMore(
    ...
    desc:
        "(2 km to the west of Kottayam)\n\nBuilt in 1550 AD, this church belongs to the Knanaya Orthodox Syrian community. The Persian cross, believed to be one of the seven brought by St. Thomas, and the Pahlavi inscriptions of this church are famous.\n\n The annual festival, St. George's Feast falls on April 24. \nPh: +914812563324. \n(Open 08:00-20:00 hrs)",
    bgcolor: Color(0xFFFFF7EC),
    iconColor: Color.fromARGB(255, 236, 199, 119),
  ),
  PilgrimViewMore(
      ...
      desc:
          "(2 km from Kottayam)\n\nBuilt in 1579 by Thekkumkoor Maharajah, this church displays outstanding architecture style that is a blend of Kerala and Portuguese styles. The walls are adorned with beautiful murals made in oriental and western styles on biblical and non-biblical themes.\n\n Feast Day: January 15.\nPh:2566744. \nwww.kottayamcheriapally.com ,\n(Open 0800-1800 hrs)",
      bgcolor: Color(0xFFFCF0F0),
      iconColor: Color.fromARGB(255, 236, 151, 158)),
  PilgrimViewMore(
  ...
  PilgrimViewMore(
    ...
    desc:
        "(25 km from Kottayam)\n\nThe Surya Temple is the only temple dedicated to Aditya, the Sun God, In Kerala. \nThe first and last Sundays of the zodiacs, Scorpio (November December) and Arles (April-May), are considered auspicious to visit the temple.",
    bgcolor: Color(0xFFFFF7EC),
    iconColor: Color.fromARGB(255, 236, 199, 119),
  ),
  PilgrimViewMore(
