...
class ViewMoreCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Card(
                    child: ListTile(
                      tileColor: pilgrimviewmore.bgcolor,
                      leading: Icon(Icons.holiday_village,color: pilgrimviewmore.iconColor,),
                      title: Text(pilgrimviewmore.title),
                      subtitle: Text(pilgrimviewmore.desc,textAlign: TextAlign.justify,),
