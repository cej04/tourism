...
List<PilgrimViewMore> pilgrimviewmore = [
  PilgrimViewMore(
    title: "Aruvithira Church:(11 km from Kottayam)",
    desc:
  ...
  PilgrimViewMore(
      title: "Bhagavathy Temple, Ambalakkadavu: (3 km from Kottayam)",
      desc:
  ...
  PilgrimViewMore(
      title: "Bhagavathy Temple, Manarcad: (8 km from Kottayam)",
      desc:
  ...
  PilgrimViewMore(
    title: "Dharmasastha Temple, Pakkil:(3 km from Kottayam)",
    desc:
  ...
  PilgrimViewMore(
      title: "Kaduthuruthi Vallapalli (25 km from Kottayam)",
      desc:
      ...
      iconColor: Color.fromARGB(255, 236, 151, 158)),
  PilgrimViewMore(
      title: "Kalkulathukavu Temple, Vazhappalli:(18 km from Kottayam)",
      desc:
      ...
      iconColor: Color.fromARGB(255, 96, 151, 219)),
  PilgrimViewMore(
    title: "Kavil Bhagavathy Temple, Changanacherry: (18 km from Kottayam)",
    desc:
  ...
  PilgrimViewMore(
      title: "Kurisumala: (3 km from Vazhikkadavu) ",
      desc:
      ...
      iconColor: Color.fromARGB(255, 236, 151, 158)),
  PilgrimViewMore(
      title: "Pallipurathu Kavu Bhagavathy Temple: (2 km from Kottayam)",
      desc:
      ...
      iconColor: Color.fromARGB(255, 96, 151, 219)),
  PilgrimViewMore(
    title: "Pazhayapalli, Changanacherry: (21 km from Kottayam)",
    desc:
  ...
  PilgrimViewMore(
      title: "Puthenpalli Juma Masjid, Erattupetta: (40 km from Kottayam)",
      desc:
      ...
      iconColor: Color.fromARGB(255, 236, 151, 158)),
  PilgrimViewMore(
      title: "Shiva Temple, Thalikkotta: (2 km from Kottayam)",
      desc:
      ...
      iconColor: Color.fromARGB(255, 96, 151, 219)),
  PilgrimViewMore(
    title: "Shiva Temple, Vaikom: (40 km from Kottayam)",
    desc:
  ...
  PilgrimViewMore(
      title: "Sree Subramanya Swami Temple, Perunna: (20 km from Kottayam) ",
      desc:
      ...
      iconColor: Color.fromARGB(255, 236, 151, 158)),
  PilgrimViewMore(
      title: "St. George's Church, Puthupalli: (10 km from Kottayam)",
      desc:
      ...
      iconColor: Color.fromARGB(255, 96, 151, 219)),
  PilgrimViewMore(
    title: "St. Mary's Forane Church, Athirampuzha: (10 km from Kottayam)",
    desc:
  ...
  PilgrimViewMore(
      title: "St. Mary's Church, Kudamaloor: (5 km from Kottayam)",
      desc:
      ...
      iconColor: Color.fromARGB(255, 236, 151, 158)),
  PilgrimViewMore(
      title: "St. Mary's Church, Kuravilangad: (20 km from Kottayam)",
      desc:
  ...
  PilgrimViewMore(
    title:
        "St. Mary's Knanaya Church,Vallapalli: (2 km to the west of Kottayam)",
    desc:
  ...
  PilgrimViewMore(
      title: "St. Mary's Orthodox Church,Cherlapalli: (2 km from Kottayam) ",
      desc:
      ...
      iconColor: Color.fromARGB(255, 236, 151, 158)),
  PilgrimViewMore(
      title: "St. Thomas Church, Cherpungal:(21 km from Kottayam) ",
      desc:
      ...
      iconColor: Color.fromARGB(255, 96, 151, 219)),
  PilgrimViewMore(
    title: "Surya Temple, Adityapuram: (25 km from Kottayam)",
    desc:
  ...
  PilgrimViewMore(
      title: "The CSI Cathedral Church:(1 km from Kottayam) ",
      desc:
          " Built over 175 years ago, the CSI cathedral church is a monument from the British Era.",
      bgcolor: Color(0xFFFCF0F0),
      iconColor: Color.fromARGB(255, 236, 151, 158)),
  PilgrimViewMore(
      title: "Vimalagiri Church: (2 km fromKottayam) ",
      desc:
      ...
      iconColor: Color.fromARGB(255, 96, 151, 219)),
  PilgrimViewMore(
    title: "Vennimala: (15 km from Kottayam)",
    desc:
