class Welcome {
  final String image, title, description,subtitle1;
...
List<Welcome> welcome = [
  ...
  Welcome(
    image: "assets/images/history300500.jpg",
    title: " History",
    subtitle1: " Past rulers, Formation of the District, Political Agitations ",
    description:
  ...
  Welcome(
    image: "assets/images/weather300500.jpg",
    title: "Geography & Weather",
    subtitle1: "About High, Mid and Low lands.  Weather condition throughout the year",
    description:
        "Kottayam district has a total area of 2208 sq. km. The district is naturally divided into high land, midland and lowland, the bulk being constituted by the midland regions. Meenachil and Kanjirappally Taluks have high land and midland areas while Kottayam, Changanassery and Vaikom Taluks have midland and lowland areas. Kanjirappally and Meenachil Taluks have Laterite soil, where as Vaikom Taluk, part of Changanassery and Kottayam Taluks have Aluvial soil. The district has no coastal area.\n\n Weather in Kottayam remains hot and humid during the summers that span from March to May. Monsoon in Kottayam arrives by June 1, leading to rain in Kottayam between June and September. October and November witness humid weather in Kottayam. Northeast Monsoon in Kottayam also results in some rains between October and December.  The district normally gets an annual average rain fall of 3130.33mm.",
  ),
  Welcome(
    image: "assets/images/climate250500.jpg",
    title: "Demography",
    subtitle1: "The Area and Population details",
    description:
        "The district has a total area of 2208 Square Kilometer with a total population of 19,74,551 persons as per latest census.  District Composed of 2 Revenue Divisions and 5 Taluks.  For administrative convenience the district is divided into 100 Villages.  For local administration there are 11 block panchayats and 71 gram panchayats and 6 minicipalities.  The Literacy rate is 97.21%.  There are 9 Legislative assembly constituencies in the district.",
  ),
  Welcome(
    image: "assets/images/besttime300500.jpg",
    title: "Best Time to Visit",
    subtitle1: "What is best time to visit Kottayam?",
    description:
