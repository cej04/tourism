...
class ProduceCard extends StatelessWidget {
  ...
  const ProduceCard({Key? key, required this.produce, required this.press})
      : super(key: key);
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        fit: BoxFit.cover, image: AssetImage(produce.image))),
                alignment: Alignment
                ...
                child: Padding(
                    ...
                    child: Text(produce.title.toUpperCase(),
