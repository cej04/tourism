           ...
           Expanded(
            ...
            image: AssetImage(howtoreach.image))
              ...
              child: Padding(
               ...
               child: Text(howtoreach.title.toUpperCase(),  style: Theme.of(context).textTheme.labelMedium?.apply(color: Colors.white,backgroundColor:Colors.black.withOpacity(0.5), ).copyWith(letterSpacing: 1))
              )
