  ...
  child: Container(
            ...
            image: AssetImage(festivals.image))
              ...
              child: Padding(
               ...
               child: Text(festivals.title.toUpperCase(),  style: Theme.of(context).textTheme.labelMedium?.apply(color: Colors.white,backgroundColor:Colors.black.withOpacity(0.5), ).copyWith(letterSpacing: 1))
              )
