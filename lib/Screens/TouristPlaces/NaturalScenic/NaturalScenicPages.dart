...
class NaturalScenicPages extends StatelessWidget {
  const NaturalScenicPages({ Key? key,  }) : super(key: key);
              ...
              return GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(context, MaterialPageRoute(
                   builder: (context) {
                     return NaturalScenicDetail(naturalscenic: naturalscenics,);
                   } ),
                  );
                },
                child: Container(
               ...
               child: Text(naturalscenics.title.toUpperCase(),  style: Theme.of(context).textTheme.caption?.apply(color: Colors.white,backgroundColor:Colors.black.withOpacity(0.5), ).copyWith(letterSpacing: 1))
                         )
