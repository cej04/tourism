...
class TitleNaturalPage extends StatelessWidget {
  const TitleNaturalPage({
     Key? key,
    required this.icon,
    required this.title,
    required this.press,
      ...
      child: Row(
        ...
        //  TitleWithCustomUnderline(icon:icon,text: title),
          ...
          FloatingActionButton.extended(
            ...
            heroTag: "action button2",
            elevation: 0,
            backgroundColor: Colors.white,
            onPressed: press(),
             label: GestureDetector(
                 onTap: (){
                 Navigator.push(context, MaterialPageRoute(builder: (context) => ViewAllNatural() ));
               },
               child: const Text(
