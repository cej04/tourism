           ...
           // color: Colors.blue,
            child: ListView.builder(
              ...
              return GestureDetector(
               ...
               child: Text(religiouss.title.toUpperCase(),  style: Theme.of(context).textTheme.caption?.apply(color: Colors.white,backgroundColor:Colors.black.withOpacity(0.5), ).copyWith(letterSpacing: 1))
                         )
