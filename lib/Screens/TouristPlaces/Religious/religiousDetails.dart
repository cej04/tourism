...
class ReligiousDetails extends StatelessWidget {
  final Religious religious;

  const ReligiousDetails({Key? key, required this.religious}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(children: [
          ...
          GestureDetector(
            onTap: () {
              MapUtils.openMap(religious.lat, religious.long);
            },
            child: Container(
                        ...
                        Container(
                          ...
                          child: PopupMenuButton(
                            ...
                            itemBuilder: (context) {
                              return <PopupMenuItem>[
                                new PopupMenuItem(
                                    child: Text(religious.TrainDesc))
                              ];
                            },
                          ),
                        ),
