...
List<Spotlight> spotlight = [
  Spotlight(
      name: "Aymanam: (1.5 hour boat ride from Kumarakom) ",
      description:
  ...
  Spotlight(
      name: "Cheepumkal: (1 km from Kavanattinkara)",
      description:
  ...
  Spotlight(
      name: "Daivathinte Munamb: (7 km fom Kumarakom)",
      description:
  ...
  Spotlight(
      name: "Kaippuzhamuttu: (2 km from Kavanattinkara Boat Terminal)  ",
      description:
      ...
      iconColor: Color.fromARGB(255, 236, 199, 119)),
  Spotlight(
      name: "Kannadichal: (3 km from Kumarakom)",
      description:
      ...
      iconColor: Color.fromARGB(255, 236, 151, 158)),
  Spotlight(
      name: "Manchadikkari: (4 km from the BoatTerminal at Kavanattinkara) ",
      description:
      ...
      iconColor: Color.fromARGB(255, 96, 151, 219)),
  Spotlight(
      name: "Mooleapadom:(4 km from Kavanattinkara)  ",
      description:
      ...
      iconColor: Color.fromARGB(255, 236, 199, 119)),
  Spotlight(
      name: "Naragathara: (8 km from the Boat Terminal at Kavanattinkara) ",
      description:
      ...
      iconColor: Color.fromARGB(255, 236, 151, 158)),
  Spotlight(
      name: "Attamangalam Church:(10 km from Kottayam) ",
      description:
