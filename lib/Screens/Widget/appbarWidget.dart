           ...
           // color: Color(0xFF757575),
            ...
            itemBuilder: (context) => [
              ...
              PopupMenuItem<int>(
                ...
                child: Row(
                  children: [
                    Icon(Icons.flatware,color: Colors.black,),
                                            SizedBox(width: 20,),
              ...
              PopupMenuItem<int>(
                ...
                child: Row(
                  children: [
                    Icon(Icons.celebration_rounded,color: Colors.black,),
                                            SizedBox(width: 20,),
              ...
              PopupMenuItem<int>(
                ...
                child: Row(
                  children: [
                    Icon(Icons.festival_outlined,color: Colors.black,),
                                            SizedBox(width: 20,),
              ...
              PopupMenuItem<int>(
                ...
                child: Row(
                  children: [
                      Icon(Icons.commute_outlined,color: Colors.black,),
                      SizedBox(width: 20,),
                    Text(
                      "How to Reach",
                     // style: TextStyle(color: Colors.white),
